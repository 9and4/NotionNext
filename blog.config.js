...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'b565a1fcbd714b35aa2244c1c41543a8',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '胡説八道、囤書不看、通宵開燈、去埋了人的地方踩點（仕事）。,喜歡在安全的地方躺著、洗熱水澡、充足的食物和取暖設備，以及準時發放足額工資的老闆。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '@無糧硬品', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '胡説八道、囤書不看、通宵開燈、去埋了人的地方踩點（仕事）。喜歡在安全的地方躺著、洗熱水澡、充足的食物和取暖設備，以及準時發放足額工資的老闆。', // 作者简介
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/public/wuliangyp_2371039.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,twitter,email', // 分享的服務，按顺序显示,逗号隔开
